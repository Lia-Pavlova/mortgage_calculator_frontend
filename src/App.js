...
import { refresh } from './service/authorization.js'
...
const CalculatorPage = lazy(() =>
  import(
    './pages/CalculatorPage/CalculatorPage.js' /* webpackChunkName: "CalculatorPage" */
  ),
)

const NotFound = lazy(() =>
  import(
    './pages/NotFoundPage/NotFoundPage.js' /* webpackChunkName: "NotFound" */
  ),
)
